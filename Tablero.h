...
class Tablero{
	...
	private:
		...
		/*
		 * Pre : Recibe la posicion de fila y columna en la que se encuentre algun casillero
		 * Post: Devuelve verdadero si la posicion de fila y columnas recibidas pertenecen al tablero, sino devuelve falso.
		 */
